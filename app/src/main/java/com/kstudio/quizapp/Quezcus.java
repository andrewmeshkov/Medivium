...
public class Quezcus implements Serializable{
    ...
    private String answer, IsImageQuestion,Image;


    public int igd;
    private String note, level,trueAns,image,ansOption,selectedAns,langId;
    ...
    public Quezcus(int id, String question, String opt_A, String opt_B, String opt_C, String opt_D, String answer, String isImageQuestion) {
        this.id = id;
