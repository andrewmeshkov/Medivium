...
public class getreport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        circleImageView = findViewById(R.id.fotyu);
        textView1 = findViewById(R.id.StudentID);
        textView2 = findViewById(R.id.yearID);
        ...
        textView1.setText(getIntent().getStringExtra("DetailName"));
        textView2.setText(getIntent().getStringExtra("DetailYear"));
        String Temp = getIntent().getStringExtra("TestNAME") + " РЕЗУЛЬТАТ : " + getIntent().getStringExtra("Marks");
